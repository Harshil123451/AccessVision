...
| :--- | :--- | :--- | :--- |
| **Image Captioning (Avg)** | 1617.3 ms | 2674.8 ms | 0.6x speedup / difference |
| **Visual Question Answering (Avg)** | 815.1 ms | 2201.6 ms | 0.4x speedup / difference |
| **Model Load RAM Overhead** | ~350 MB | ~770 MB | Florence-2 is heavier in memory |
| **Total Memory footprint** | 3872.9 MB | 3872.9 MB | Matches Hugging Face free tier limit (16GB) |
