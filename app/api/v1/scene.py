...
@router.post(
    "/stream",
    summary="Stream progressive scene understanding events",
    description="Progressively yields scene analysis narration stages (YOLO -> Tracker -> Color -> Florence enrichment) as Server-Sent Events."
)
async def stream_scene(
    ...
    return StreamingResponse(
        service.stream_scene_analysis(optimized_bytes, is_mirrored=is_mirrored, session_id=session_id),
