...
async def detect_objects(
    ...
    confidence: Optional[float] = Query(default=None, ge=0.0, le=1.0, description="Minimum confidence threshold"),
    is_mirrored: bool = Query(default=False, description="Whether the camera preview was mirrored"),
